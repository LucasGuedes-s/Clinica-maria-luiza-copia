...
export default {
    ...
    methods: {
        ...
        async getDados() {
            ...
            Axios.get(`https://clinica-maria-luiza-copia-fqrm.onrender.com/paciente/dados/${this.id}`, {
                headers: {
        ...
        async editarDadosPaciente() {
            ...
            try {
                ...
                await Axios.post(`https://clinica-maria-luiza-copia-fqrm.onrender.com/editar/dados/paciente`, {
                    dados: {
