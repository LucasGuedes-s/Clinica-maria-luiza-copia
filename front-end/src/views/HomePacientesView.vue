...
export default {
    ...
    methods: {
            ...
            async getAgenda() {
                await Axios.get(`https://clinica-maria-luiza.onrender.com/pacientes/agendamentos/${this.cpf}`
                ).then(response => {
            ...
            async getConsultas() {
                Axios.get(`https://clinica-maria-luiza.onrender.com/consultas/paciente/${this.cpf}`,
